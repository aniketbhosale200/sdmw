...
def generate_launch_description():
    ...
    model_arg = DeclareLaunchArgument(
        name="model",
        default_value=os.path.join(robot_base_dir, "urdf", "smdw_robot_base.urdf.xacro"),
    ...
    #     name="rviz_config",
    #     default_value=os.path.join(robot_base_dir, "rviz", "config.rviz"),
    ...
    world_arg = DeclareLaunchArgument(
        name="world",
        default_value=os.path.join(robot_base_dir, "worlds", "empty.world"),
    ...
    # Generate robot_description from Xacro (note: removed extra space from 'xacro ')
    ...
    gazebo_model_path = SetEnvironmentVariable(
        ...
        value=os.path.join(robot_base_dir, "models")
    )
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "extra_gazebo_args": "--max_step_size 0.001 --real_time_update_rate 1000"
        }.items()
    )
