...
def generate_launch_description():
    agri_bot_dir = get_package_share_directory("agri_bot")
    
    # Declare argument for model path
    model_arg = DeclareLaunchArgument(
        name="model",
        default_value=os.path.join(agri_bot_dir, "urdf", "agri_bot.urdf.xacro"),
    ...
    rviz_config_arg = DeclareLaunchArgument(
        name="rviz_config",
        default_value=os.path.join(agri_bot_dir, "rviz", "agri_bot_config.rviz"),
    ...
    world_arg = DeclareLaunchArgument(
        name="world",
        default_value=os.path.join(agri_bot_dir, "worlds", "empty.world"),
    ...
    gazebo_model_path = SetEnvironmentVariable(
        ...
        value=os.path.join(agri_bot_dir, "models")
    )
